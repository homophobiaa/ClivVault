...
import { Plus, Search, Clipboard, X } from 'lucide-react'
...
export default function App() {
  const {
    snippets, allCount, query, setQuery,
    ...
    <div className="min-h-screen bg-zinc-950 text-white">
      ...
      <header className="sticky top-0 z-30 border-b border-white/[0.06] bg-zinc-950/80 backdrop-blur-xl">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-4 flex items-center justify-between gap-4">
          ...
          <button
            onClick={openNew}
            className="flex items-center gap-2 px-3.5 py-2 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white text-sm font-semibold shrink-0 transition-colors shadow-lg shadow-indigo-500/20"
          >
            <Plus size={15} />
